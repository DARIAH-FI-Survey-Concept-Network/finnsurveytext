...
This tutorial goes into further details demonstrating the use of the package, covering functions in `r/02_data_exploration.R` and `r/02_data_exploration.R`. The intention is to provide an example of some initial analysis of open-ended survey questions being used to inform the settings and concept words of the Concept Network plot and then how you can be fine-tune these to produce plots that provide useful insights during analysis and are which are more persuasive visualisations of your findings.
