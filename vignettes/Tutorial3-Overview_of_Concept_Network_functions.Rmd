...
## Introduction
This tutorial follows on from Tutorial 2 and guides you through creation of a concept network plot. A concept network is a good way to visualise the data which allows for interpretation.
...
```{r}
bullying_nodes <- fst_cn_nodes(bullying, bullying_edges)
...
This tutorial ran you through the Concept Network functions included in `finnsurveytext`. A concept network visualises word importance and co-occurence between words. 
