...
A comparison cloud compares the relative frequency with which a term is used in two or more documents. This cloud shows words that occur more regularly in responses from a specific type of respondent. For more information about comparison clouds, you can read [this documentation](https://cran.r-project.org/web/packages/wordcloud/wordcloud.pdf) Our data is quite unbalanced (there are a lot more female respondents and fewer 'NA' so this may skew responses) but it seems that a higher proportion of these 'NA' respondents use 'ihminen' and 'auttaa' in their responses. Similarly, 'raha' and 'yrittää' are associated with males and females respectively.  
