...
* `fst_join_unique`: 
  ...
  + `unique` is the output of `fst_get_unique`
* `fst_ngrams_compare_plot`: 
  + `table` is the table of words/n-grams, output of `get_unique_ngrams`
