...
```{r}
conllu_dev_q11_1 <- fst_format(data = dev_coop, field = "q11_1")
conllu_cb_bullying <- fst_format(data = child, field = "q7", model = "tdt")
```
...
* InDetail4-Further analysis and configuration of Concept Network functions
* InDetail5-ComparisonFunctions
* InDetail6-ExampleAnalysisofQuestion
